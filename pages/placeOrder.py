...
class PlaceOrder(BaseClass):
    ...
    def addToCart(self):
        ...
        self.sendKeys(*self.quantityField, "2")
    ...
    def verifyCart(self):
        cartProductName = self.getElementText(By.XPATH, "//h4[@class='product-name']")
        cartProductPrice = self.getElementText(By.XPATH, "//p[@class='price']")
    ...
    def payment():
        ...
        self.sendKeys(*self.nameOnCard, "John Doe")
        self.sendKeys(*self.cardNumber, "4111111111111111")
        self.sendKeys(*self.cvcNumber, "123")
        self.sendKeys(*self.expirationMM, "12")
        ...
        assert "Order Placed!" in orderPlacedMessage, f"Expected order placed message to contain 'Order Placed!', got '{orderPlacedMessage}'"
